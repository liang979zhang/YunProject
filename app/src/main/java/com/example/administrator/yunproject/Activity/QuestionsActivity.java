...
//    http://192.168.252.111:88/index.php?app=classroom&mod=My&act=addReview&albumid=171&uid=1
    private String adUrl = ApiService.BASE_URL + "index.php?app=classroom&mod=My&act=addquestion";
    private int videoId;
    private int userId;
    ...
    private void initView() {
        questionWeb.getSettings().setRenderPriority(WebSettings.RenderPriority.HIGH);
...
//        nativeWeb.setWebChromeClient(new MyChromeWebClient());
        questionWeb.loadUrl(adUrl+"&albumid="+videoId+"&uid="+userId);
