...
public class OrderInfoUtil2_0 {
    ...
    public static Map<String, String> buildOrderParamMap(Activity activity,String app_id, boolean rsa2, ZfbPayBean zfbPayBean) {
        ...
        keyValues.put("biz_content", getzfbData(zfbPayBean));
    ...
    public static String getzfbData(ZfbPayBean zfbPayBean) {
        ...
        aaMap.put("timeout_express", "30");
        aaMap.put("product_code", "QUICK_MSECURITY_PAY");
        aaMap.put("total_amount", zfbPayBean.getTotal_amount());
        aaMap.put("subject", zfbPayBean.getSubject());
        aaMap.put("body", zfbPayBean.getBody());
        aaMap.put("out_trade_no", getOutTradeNo());
        String s = new Gson().toJson(aaMap);
        return s;
    }
