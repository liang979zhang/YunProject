...
import com.example.gsyvideoplayer.listener.LockClickListener;
import com.example.gsyvideoplayer.listener.StandardVideoAllCallBack;
...
//            gsyVideoPlayer.setBackListener(mLockClickListener);
//            gsyVideoPlayer.getBackButton().setOnClickListener(mLockClickListener );
//            gsyVideoPlayer.getmBackButton().setOnClickListener(ger);
    ...
    public void setBackListener(LockClickListener lockClickListener) {
        this.mLockClickListener = lockClickListener;
    }
